    ...
    def dis(self, img1, img2, params=None):
        ...
        if params is None:
            params = {
                ...
                'grad_descent_iter': 8,
                'var_refine_iter': 3,
                'var_refine_alpha': 10.0,
                'var_refine_delta': 2.0,
                'var_refine_gamma': 5.0,
        ...
        dis.setVariationalRefinementIterations(params.get('var_refine_iter', 7))
        dis.setVariationalRefinementAlpha(params.get('var_refine_alpha', 50.0))
