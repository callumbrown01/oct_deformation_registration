...
image_folder = "test_images_1/extracted_images"
output_folder = "test_images_1/output_images"
...
# ** Step 2: Track Grid Points Using Optical Flow **
...
for i in range(1, len(image_files)):
    ...
    # ** Step 3: Deform and Overlay the Grid **
